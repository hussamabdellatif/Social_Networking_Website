...
<body>
    ...
    <div class="container">
        <h1 style="padding-bottom: 5px;">Results For Your Search: "<?php echo $_GET['query'];?> "</h1>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div style="max-height: 400px; overflow-y: auto; padding-left: 3px">
                        <form action="user-page.html" method="POST" enctype="multipart/form-data">
...
<div class="modal fade" id="commentsmodal" role="dialog" tabindex="-1" style="padding-top:100px;">
    ...
    <script type="text/javascript">
         ...
         $("#getsearchval").keyup(function(event){
    if(event.keyCode == 13){
     location.href = "searcheng.php?query="+$("#getsearchval").val()+"";
    }
});
        ...
        $.ajax({
            ...
            type: "GET",
            url: "api/search?query=<?php echo $_GET['query']?>",
            processData: false,
